...
?>
    ...
    <div class = "contenido">
        <div class = "info">
            ...
            <p>
                ...
                clientes herramientas avanzadas que optimicen la operación, seguridad y rendimiento de sus vehículos
            </p>
        </div>
    ...
    <div class = "contenido">
        <div class = "imagen">
            <img src="css/img/imasobrenosotros.jpg" alt="Carros en movimiento">
        </div>
            <div class = "info">
                <h2>Mision</h2>
                <p>
    ...
    <div class="contenido">
        ...
        <div class="imagen">
            <img src="css/img/slider.jpg" alt="camion">
        </div>
    </div>
