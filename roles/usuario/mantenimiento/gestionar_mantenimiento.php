...
<div class="container">
    ...
    <form action="gestionar_mantenimiento.php" method="post" class="form-group">
        ...
        <select name="id_tipo_mantenimiento" required>
            ...
            <?php foreach ($tipos_mantenimiento as $tipo): ?>
                <option value="<?php echo htmlspecialchars($tipo['id_tipo_mantenimiento']); ?>">
        ...
        <input type="date" name="fecha_realizada">
        ...
        <input type="number" name="proximo_cambio_km">

        <label for="proximo_cambio_fecha">Próximo Mantenimiento (Fecha):</label>
        <input type="date" name="proximo_cambio_fecha">
        ...
        <div id="trabajos-container">
            <button type="button" onclick="agregarTrabajo()">Agregar Trabajo</button>
        </div>
