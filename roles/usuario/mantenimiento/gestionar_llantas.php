...
<div class="container">
    ...
    <!-- Formulario para registrar revisión de llantas -->
    <form action="gestionar_llantas.php" method="post" class="form-group">
        ...
        <input type="date" name="ultimo_cambio">

        <label for="presion_llantas">Presión de Llantas (PSI):</label>
        <input type="number" step="0.1" name="presion_llantas">
