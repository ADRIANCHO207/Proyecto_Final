...
<div class="header">
    <div class="logo">
        <a href="/Proyecto_Final/roles/user/index.php">
            <img src="/Proyecto_Final/roles/user/css/img/logo.jpeg" alt="Logo">
            <span class="empresa">Flotax AGC</span>
        </a>
    </div>
    <div class="menu">
        <a href="/Proyecto_Final/roles/user/index.php" class="boton">Inicio</a>
        <a href="/Proyecto_Final/roles/user/vehiculos/formulario.php" class="boton">Registrar Vehículo</a>
    </div>
    ...
    <div id="profileModal" class="modal">
        <div class="modal-content">
            ...
            <?php if ($foto_perfil === '/Proyecto_Final/roles/user/css/img/perfil.jpg'): ?>
            <?php endif; ?>
            ...
            <form action="/Proyecto_Final/roles/user/actualizar_foto.php" method="post" enctype="multipart/form-data">
            ...
            <form action="/Proyecto_Final/roles/user/actualizar_foto.php" method="post">
